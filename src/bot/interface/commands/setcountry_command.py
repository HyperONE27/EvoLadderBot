...
from src.bot.utils.discord_utils import log_user_action, get_user_info
...
async def setcountry_command(interaction: discord.Interaction, country_code: str):
    ...
    async def confirm_callback(interaction: discord.Interaction):
        ...
        log_user_action(
            user_info, "set country", f"to {country['name']} ({country_code})"
        )
    ...
    class CountryCancelView(discord.ui.View):
        ...
        @discord.ui.button(
            label="Try Again", emoji="🔄", style=discord.ButtonStyle.secondary
        )
        async def retry(
...
def register_setcountry_command(tree: app_commands.CommandTree):
    ...
    @tree.command(name="setcountry", description="Set or update your country")
