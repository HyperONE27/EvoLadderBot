...
MM_HIGH_PRESSURE_PARAMS = (100, 50)
MM_MODERATE_PRESSURE_PARAMS = (100, 50)
MM_LOW_PRESSURE_PARAMS = (100, 50)
MM_DEFAULT_PARAMS = (100, 50)

# --- Queue Pressure Calculation ---
MM_POPULATION_THRESHOLD_LOW = 10
MM_POPULATION_THRESHOLD_MID = 25
MM_PRESSURE_SCALE_LOW_POP = 1.0
MM_PRESSURE_SCALE_MID_POP = 1.0
MM_PRESSURE_SCALE_HIGH_POP = 1.0
